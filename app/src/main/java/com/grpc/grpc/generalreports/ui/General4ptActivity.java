...
public class General4ptActivity extends AppCompatActivity {
    ...
    private static final double DEFAULT_ANNUAL_FEE = 700.0;
    ...
    private static final int REQUEST_PREVIEW_CONTRACT_QUOTE = 904;
    /** Ensures Preview and Confirm use the same quote number. */
    ...
    /** Builds quote data, generates PDF and returns the file; null if validation or generation fails. */
    ...
    public static File generateQuotationReport(
        ...
        return generateQuotationReport(fileName, address, quoteDescription, descriptions, lineTotals,
                userEmail, mobileNumber, staffName, staffTitle, companyName, companyContact, context, ownerPassword, null);
    }
