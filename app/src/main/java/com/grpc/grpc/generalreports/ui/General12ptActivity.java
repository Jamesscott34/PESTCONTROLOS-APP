...
public class General12ptActivity extends AppCompatActivity {
    ...
    private static final String PREF_KEY_ANNUAL_FEE = "CONTRACT_QUOTE_ANNUAL_FEE_12PT";
    private static final double DEFAULT_ANNUAL_FEE = 1000.0;
    ...
    private static final int REQUEST_PREVIEW_CONTRACT_QUOTE = 912;
