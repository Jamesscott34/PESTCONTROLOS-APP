...
public final class ProductListsLoader {
    ...
    public static List<String> loadAllProductNames(@Nullable Context context) {

        ProductLists lists = load(context);

        return lists != null ? lists.allNames : Collections.emptyList();
    ...
    private static ProductLists parse(String json) throws Exception {
        ...
        List<String> materials = readStringArray(root.optJSONArray("materials"));

        return new ProductLists(rodenticides, insecticides, materials);
    ...
    public static final class ProductLists {
        ...
        public ProductLists(List<String> rodenticides,

                            List<String> insecticides,
            ...
            this.allNames = mergeUnique(this.rodenticides, this.insecticides, this.materials);
