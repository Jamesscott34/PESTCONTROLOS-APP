...
import com.grpc.grpc.files.ui.FolderAdapter;
...
public class StoredReportsActivity extends AppCompatActivity {
    ...
    /** When set, open this folder path and show its files (e.g. "Reports25/January"). Used from Search. */
    ...
    private void viewFile(String folder, String fileName) {
        ...
        fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
            com.grpc.grpc.core.StorageMetricsHelper.recordDownload();
