...
import com.grpc.grpc.era.pdf.ToxicERAPDFGenerator;
...
public class ToxicERAActivity extends AppCompatActivity {
    private static final int REQUEST_PREVIEW_ERA = 937;
    ...
    private void previewPDF() {
        ...
        String pdfPath = ToxicERAPDFGenerator.generateToxicEnvironmentalRiskAssessment(
                this,
                companyName,
                address,
                email,
